        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <button class="btn my-3 btn-primary" rel="tooltip" title="Add" 
              ...
              <!-- <i class="far fa-edit"></i> --> Tambah Tugas
            </button>
             <div class="card">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="deskripsi" id="subject_deskripsi" class="form-control">
                        </div>
                        <div class="form-group">
                          <label class="bmd-label-floating">Status</label>
                          <input type="text" name="status" id="subject_Status" class="form-control">
                        </div>
                      </div>
           ...
           <div class="modal fade" id="AddModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    ...
                    <button type="submit" class="btn btn-primary pull-right mt-4">Tambah Tugas</button>
                    <div class="clearfix"></div>
                  </form>
