                  ...
                  <div class="table-responsive">
                    <table id="example" class="table table-striped" >
                      ...
                      <tr>
                        ...
                        <td>{{$result->subject->deskripsi}}</td>
                        <td>{{$result->subject->status}}</td>  
           ...
           <div class="modal fade" id="editModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Update Datass</h5>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">sstatus</label>
                          <input type="text" name="status" id="view-status" class="form-control"disabled>
                        </div>
                      </div>
