                        ...
                        <div class="form-group">
                          <label class="bmd-label-floating">student Name</label>
                            ...
                            <div class="form-group" name="student">
                                {{$data->name}}
                               <input type="text" id="subject_name" value="{{$data->name}}" class="form-control" disabled> 
                        ...
                        <div class="form-group">
                          <label class="bmd-label-floating">Deskripsi</label>
                            ...
                            <div class="form-group" name="deskripsi">
                                {{$data->deskripsi}}
                               <input type="text" id="subject_deskripsi" value="{{$data->deskripsi}}" class="form-control" disabled> 
                        ...
                        <div class="form-group">
                          <label class="bmd-label-floating">status</label>
                            ...
                            <div class="form-group" name="status">
                                {{$data->status}}
                               <input type="text" id="subject_Status" value="{{$data->status}}" class="form-control" disabled> 
